...
A:mother is a son-murdering psychopath_
B: two of her children are found dead with no evidence of physical harm_
...
```{r}
se_ps=sqrt(1/(1/sigma^2+1/tau^2))
se_ps
```
